...
public class BebidasView extends AppCompatActivity {
    EditText cantidad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bebidas_view);
        cantidad = (EditText) findViewById(R.id.textCantidadBebidas);
        cantidad.setText("0");
        listaBebidas = (ListView) findViewById(R.id.listViewBebidas);
        cargarView();
